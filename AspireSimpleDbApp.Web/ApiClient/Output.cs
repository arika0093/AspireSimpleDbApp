...
namespace AspireSimpleDbApp.Web.ApiClient
{
    /// <summary>No summary available</summary>
    [System.CodeDom.Compiler.GeneratedCode("Refitter", "1.7.1.0")]
    public partial interface IAspireSimpleDbAppApiServiceApi
    {
        /// <returns>OK</returns>
...
/// <param name="builder">Optional action to configure the HTTP client builder.</param>
        ...
        {
            var clientBuilderIAspireSimpleDbAppApiServiceApi = services
                .AddRefitClient<IAspireSimpleDbAppApiServiceApi>(settings)
                .ConfigureHttpClient(c => c.BaseAddress = new Uri("https+http://apiservice"));

            builder?.Invoke(clientBuilderIAspireSimpleDbAppApiServiceApi);
